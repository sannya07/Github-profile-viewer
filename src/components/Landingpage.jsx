...
function Landingpage() {
  ...
  return (
    ...
    <div className='flex-col flex w-full h-screen min-h-full bg-gradient-to-r from-slate-900 to-zinc-500 md:flex-row'>
        ...
        <div className='flex flex-col w-full h-screen bg-[#0d1116] justify-center md:w-1/2'>
        <div className='flex pb-14'><img src="https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg" alt="" className=' max-h-[450px] bg-slate-200 rounded-full border-4 w-1/4 ' /></div>
